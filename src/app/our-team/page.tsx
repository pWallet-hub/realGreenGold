  ...
  return (
    <div className={`${poppins.className} min-h-screen flex flex-col bg-[#FAF9F6] text-[#0C1E12] selection:bg-[#E5B800] selection:text-[#0C1E12]`}>
      ...
      <main className="flex-grow space-y-12">
        ...
        <section className="relative h-[50vh] min-h-[420px] flex items-center justify-center overflow-hidden border-b border-[#00A859]/30 bg-[#0C1E12]">
          <Image
            src="/assets/home.jpg"
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#0C1E12] via-[#0C1E12]/50 to-transparent" />
